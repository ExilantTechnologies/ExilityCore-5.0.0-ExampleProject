...
dataTypes['timeStamp'] = new DateDataType('timeStamp', 'invalidDateTime',
		3650000, 730000, true);
...
dataTypes['code'] = new TextDataType('code', 'invalidCode',
		/^[\d\w\.\-_]{0,20}/, 0, 20);

dataTypes['pastDate'] = new DateDataType('pastDate', 'invalidPastDate',
		3650000, 0, false);
...
dataTypes['decimal'] = new DecimalDataType('decimal', 'invalidDecimal', 0.0,
		9.9999999E14, false, 6);

dataTypes['entityName'] = new TextDataType('entityName', 'invalidEntityName',
		/^[a-zA-Z.][a-zA-Z0-9.-_]*$/, 0, 250);

dataTypes['id'] = new IntegralDataType('id', 'invalidId', -9999999999999,
		99999999999999, true);

dataTypes['futureDate'] = new DateDataType('futureDate', 'invalidFutureDate',
		0, 730000, false);

dataTypes['price'] = new TextDataType('price', 'invalidPrice',
		/^\d+(\.\d\d?)?(\sw*)?/, 0, 20);

dataTypes['amt2'] = new DecimalDataType('amt2', 'invalidAmt2', 0.0, 1.0E16,
		false, 2);
...
dataTypes['signedNumber'] = new IntegralDataType('signedNumber',
		'invalidSignedNumber', -99999999999999, 99999999999999, true);
...
dataTypes['signedDecimal'] = new DecimalDataType('signedDecimal',
		'invalidSignedDecimal', -9.9999999999999E13, 9.9999999999999E13, true,
		6);
