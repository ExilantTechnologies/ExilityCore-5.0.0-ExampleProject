 ...
 var ele;
var P2 = new PM.ExilityPage(window, 'testGridAsDisplay');
P2.onLoadActionNames = [ 'getFiles'];
P2.pageWidth = 1028;
P2.pageHeight = 700;
P2.trackFieldChanges = true;
P2.breadCrumpTitle = 'testGridAsDisplay';
ele = new PM.AssistedInputField();
ele.dataType = 'text';
ele.isRequired = true;
ele.listServiceId = 'files';
ele.onChangeActionName = 'getMessages';
ele.noAutoLoad = true;
...
ele.renderAsADisplayPanel = true;
...
ele.closeWindow = true;
P2.addAction(ele);
/***** action field = deleteThisRow  ********/
ele = new PM.LocalAction();
ele.name = 'deleteThisRow';
ele.functionName = 'deleteThisRow';
P2.addAction(ele);
/***** action field = close  ********/
