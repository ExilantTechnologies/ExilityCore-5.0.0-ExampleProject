...
var stateCrops = [
	                 ...
	                 ,['Andra PradeshPradeshPradesh', 20 ,'sugarcane','20% area is cultivalted with sugarcane'] 
	                 ,['Andra PradeshPradeshPradesh', 10 ,'cotton','10% area is cultivalted with cotton']
	                /* ,['Andra PradeshPradeshPradesh', 5 ,'Tea','5% area is cultivalted with tea'] */
	                 
	                 ,['Karnataka', 40 ,'sugarcane','40% area is cultivalted with sugarcane']
	               /*  ,['Karnataka', 60 ,'cotton','60% area is cultivalted with cotton']*/
	                 ,['Karnataka', 20 ,'Tea','20% area is cultivalted with tea']
	                 
	                 ,['Madhya Pradesh', 10 ,'sugarcane','10% area is cultivalted with sugarcane'] 
	                 ,['Madhya Pradesh', 30 ,'cotton','30% area is cultivalted with cotton']
	                 ,['Madhya Pradesh', 5 ,'Tea','5% area is cultivalted with tea']    
                 ];

var pieData = [
               ['functionalGroup', 'count','ttip']
...
var sunBurstData = [
	               ['source', 'level1','level2','distribution','ttip']
