...
(function() {
  ...
  contextPrototype.fillText = function(textData, aX, aY, textColor) {
    var lineStr = [];
    ...
    p.y = p.y/10;
    lineStr.push('<g_vml_:shape',
                 ' style=\'position:absolute;margin-left:', p.x, '; margin-top:', p.y, ';width:', (textData.length * 5), ';height:', H, ';\'',
                 ' coordsize="', Z * W, ',', Z * H, '"',
                 ' path="m0,0l100,0m0,100l100,100e">');
    // Apr 14 2010 : Bug 1109 - Bubble Chart - Exility App (Start) : Aravinda
    if(textColor) {
        lineStr.push('<g_vml_:stroke color="' + textColor + '" />');
    }
    // Apr 14 2010 : Bug 1109 - Bubble Chart - Exility App (End) : Aravinda
    lineStr.push('<g_vml_:path textpathok="t"/>');
    lineStr.push('<g_vml_:textpath on="t" fitpath="t" fitshape="t" string="' + textData + '"/>');
    lineStr.push('</g_vml_:shape>');
